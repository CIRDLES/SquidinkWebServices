...
public class SpotsPullServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().write(gson.toJson(squid.getReferenceMaterialSampleName()));
        response.getWriter().write(gson.toJson(squid.getConcReferenceMaterialSampleName()));
